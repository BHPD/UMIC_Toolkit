...
class SingleMultiFrame(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        self.info=customtkinter.CTkLabel(
            self, 
            text='Processes multiple single .emd files' +
    ...
    def convert(self):
        def task():
            self.progress.start()
            # Essentially use mosaic processing.
            bf.processMosaicSingle(self,
        ...
        if not self.file_export_path or not self.file_input_path:
            self.popup.configure(text='Select a folder first!')
            return    
